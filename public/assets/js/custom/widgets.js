        ...
        !function () {
            ...
            if (e) {
                var a = e.getAttribute("data-kt-chart-color"), o = KTUtil.getCssVariableValue("--bs-gray-800"),
                    r = KTUtil.getCssVariableValue("--bs-" + a), s = KTUtil.getCssVariableValue("--bs-" + a + "-light");
                new ApexCharts(e, {
                    series: [{name: "Calls", data: [30, 45, 32, 70, 40]}],
                    chart: {
                        fontFamily: "inherit",
                        type: "area",
                        height: t,
                ...
                var t = {self: null, rendered: !1}, a = function () {
                    var a = parseInt(KTUtil.css(e, "height")), o = KTUtil.getCssVariableValue("--bs-gray-500"),
                        r = KTUtil.getCssVariableValue("--bs-gray-200"), s = {
                            ...
                            colors: [KTUtil.getCssVariableValue("--bs-warning"), KTUtil.getCssVariableValue("--bs-gray-300")],
                            grid: {borderColor: r, strokeDashArray: 4, yaxis: {lines: {show: !0}}}
                        };
                    t.self = new ApexCharts(e, s), t.self.render(), t.rendered = !0
                };
            ...
            if (e) {
                var t = {self: null, rendered: !1}, a = function () {
                    ...
                    var a = KTUtil.getCssVariableValue("--bs-gray-500"),
                        o = KTUtil.getCssVariableValue("--bs-gray-200"), r = KTUtil.getCssVariableValue("--bs-info"),
                        s = {
            ...
            if (e) {
                var t = {self: null, rendered: !1}, a = function () {
                    parseInt(KTUtil.css(e, "height"));
                    var a = KTUtil.getCssVariableValue("--bs-gray-500"),
                        o = KTUtil.getCssVariableValue("--bs-gray-200"), r = KTUtil.getCssVariableValue("--bs-success"),
                        s = KTUtil.getCssVariableValue("--bs-success-light"),
                        l = KTUtil.getCssVariableValue("--bs-warning"),
                        i = KTUtil.getCssVariableValue("--bs-warning-light"), n = {
            ...
            if (e) {
                var t = {self: null, rendered: !1}, a = function () {
                    parseInt(KTUtil.css(e, "height"));
                    var a = KTUtil.getCssVariableValue("--bs-gray-500"),
                        o = KTUtil.getCssVariableValue("--bs-gray-200"), r = {
            ...
            if (e) {
                var t = {self: null, rendered: !1}, a = function () {
                    parseInt(KTUtil.css(e, "height"));
                    var a = KTUtil.getCssVariableValue("--bs-gray-500"),
                        o = KTUtil.getCssVariableValue("--bs-gray-200"), r = KTUtil.getCssVariableValue("--bs-primary"),
                        s = KTUtil.getCssVariableValue("--bs-primary-light"), l = {
                            series: [{
                                name: "Net Profit",
                                type: "bar",
                                stacked: !0,
            ...
            if (e) {
                var t = {self: null, rendered: !1}, a = function () {
                    var a = parseInt(KTUtil.css(e, "height")), o = KTUtil.getCssVariableValue("--bs-gray-500"),
                        ...
                        s = KTUtil.getCssVariableValue("--bs-gray-300"), l = KTUtil.getCssVariableValue("--bs-warning"),
                        ...
                        c = KTUtil.getCssVariableValue("--bs-primary"), h = {
            ...
            var e, t, a, o = document.querySelectorAll(".mixed-widget-2-chart"),
                r = KTUtil.getCssVariableValue("--bs-gray-500"), s = KTUtil.getCssVariableValue("--bs-gray-200");
            ...
            [].slice.call(e).map((function (e) {
                ...
                if (e) {
                    var a = e.getAttribute("data-kt-chart-color"), o = KTUtil.getCssVariableValue("--bs-gray-800"),
                        r = KTUtil.getCssVariableValue("--bs-gray-300"), s = KTUtil.getCssVariableValue("--bs-" + a),
            ...
            var e = document.querySelectorAll(".mixed-widget-5-chart"), t = function (e, t) {
                var a = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = t.getAttribute("data-kt-chart-color"), r = KTUtil.getCssVariableValue("--bs-gray-800"),
                        s = KTUtil.getCssVariableValue("--bs-gray-300"), l = KTUtil.getCssVariableValue("--bs-" + o),
                        i = KTUtil.getCssVariableValue("--bs-" + o + "-light"), n = {
                            ...
                            colors: [i],
                            markers: {colors: [i], strokeColor: [l], strokeWidth: 3}
                        };
                    e.self = new ApexCharts(t, n), e.self.render(), e.rendered = !0
                }
            };
            [].slice.call(e).map((function (e) {
                var a = {self: null, rendered: !1};
            ...
            function t() {
                ...
                if (t) {
                    var o = KTUtil.getCssVariableValue("--bs-gray-800"), r = KTUtil.getCssVariableValue("--bs-info"),
                        s = KTUtil.getCssVariableValue("--bs-info-light"), l = {
                            series: [{name: "Calls", data: [30, 25, 45, 30, 55, 55]}],
                            chart: {
                                fontFamily: "inherit",
                                type: "area",
                                height: a,
