                ...
                <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                    <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                        ...
                        <div class="text-gray-500 fw-semibold fs-6">
                            <h5>AL-HAWIA RUKMIYYA ESTABLISHMENT FOR IT</h5>
                            <p><b>Contract Us</b></p>
                            Email Address: <a class="text-decoration-underline" href="mailto:info@codency.app">info@codency.app</a>
                            <br>
                            Cell Phone: <a class="text-decoration-underline" href="tel:966593495575">+966 5934 95575</a>
                        </div>
                    </div>
