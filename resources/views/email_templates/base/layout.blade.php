...
<table role="presentation" align="center" border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="#F3F2EF"
    ...
    <tbody>
    <tr>
        <td align="center" bgcolor="#E9E5DF" style="background-color:#e9e5df;">
            <center style="width:100%">
                <table role="presentation" border="0" class="m_-4742265021905027275mercado-email-container"
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF"
                            style="background-color:#ffffff;padding:18px 24px 0 24px; border-top: 5px solid #0a66c2">
                            <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%"
                                ...
                                <tr>
                                    <td align="left" valign="middle">
                                        <a
                                            ...
                                            <img alt="Codency" border="0"
                                                 src="{{ asset('assets/media/logos/demo3.svg') }}"
                                                 height="38"
                                    ...
                                    <td valign="middle" width="100%" align="right"><a
                                            href="{{ url('/') }}"
                                            style="margin:0;color:#0a66c2;display:inline-block;text-decoration:none"
                                            target="_blank"
                                            data-saferedirecturl="https://www.google.com/url?q={{ url('/') }}">
                                            <p style="margin:0;font-weight:400"></p><span
                                                style="word-wrap:break-word;color:#000000;word-break:break-word;font-weight:400;font-size:14px;line-height:1.429">{{ $username }}</span>
                                                    ...
                                                    <table role="presentation" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                style="padding:0;color:#000000;text-align:left"><p
                                                                    ...
                                                                    This email was intended for {{$username}}. <a
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding:0;text-align:left"><a
                                                                    ...
                                                                    <img
                                                                        alt="Codency" border="0" height="14"
                                                                        src="{{ asset('assets/media/logos/demo3.svg') }}"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                style="padding:0;color:#000000;text-align:left"><p
                                                                    style="margin:0;color:#000000;font-weight:400;font-size:12px;line-height:1.333">
                                                                    © 2023 Codency Saudi Arabia Company.</p></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <table width="1" border="0" cellspacing="0"
